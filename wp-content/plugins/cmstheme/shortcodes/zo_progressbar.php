...
vc_map(
	array(
	    ...
	    "params" => array(
			...
			array(
				"type" => "dropdown",
				"heading" => __ ( 'Progress Color type', ZO_NAME ),
				"param_name" => "color_type",
				"value" => array(
					"Only Color" => "true",
					"Gradient color" => "false"
				),
				"group" => __("Progress Bar Settings", ZO_NAME),
			...
			array(
				"type" => "colorpicker",
				"heading" => __ ( 'Progress Color Start', ZO_NAME ),
				"param_name" => "zo_color1",
				"group" => __("Progress Bar Settings", ZO_NAME),
				"description" => __('Background color for progress.',ZO_NAME),
				'value'=>__('#288dff',ZO_NAME),
				'dependency' => array(
					'element' => 'color_type',
					'value' => 'false',
				),
			...
			array(
				"type" => "colorpicker",
				"heading" => __ ( 'Progress Color End', ZO_NAME ),
				"param_name" => "zo_color2",
				"group" => __("Progress Bar Settings", ZO_NAME),
				"description" => __('Background color for progress.',ZO_NAME),
				'value'=>__('#38e5ff',ZO_NAME),
				'dependency' => array(
					'element' => 'color_type',
					'value' => 'false',
				),
