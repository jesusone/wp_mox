...
vc_map(
	array(
	    ...
	    "params" => array(
	        ...
	        array(
	            "type" => "textfield",
	            "heading" => __("Title Counter 5",ZO_NAME),
	            "param_name" => "title5",
	            "value" => "",
	            'dependency' => array(
	            	"element"=>"zo_cols",
	        ...
	        array(
	            "type" => "dropdown",
	            "heading" => __("Counter Type 5",ZO_NAME),
	            "param_name" => "type5",
	            'dependency' => array(
					"element"=>"zo_cols",
					"value"=>array(
	        ...
	        array(
				'type' => 'iconpicker',
				'heading' => __( 'Icon Counter 5', ZO_NAME ),
				'param_name' => 'icon5',
	            'value' => '',
				'settings' => array(
					'emptyIcon' => true, // default true, display an "EMPTY" icon?
	        ...
	        array(
	            "type" => "textfield",
	            "heading" => __("Description 5",ZO_NAME),
