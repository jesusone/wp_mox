        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
            ...
            if ( ! $depth ) {
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key)  . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) ) . "]"; ?>">
                            <option value="standard" <?php echo esc_attr( ( $value == 'standard' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Standard Dropdown', 'mox' ); ?></option>
                            <option value="columns2" <?php echo esc_attr( ( $value == 'columns2' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '2 columns dropdown', 'mox' ); ?></option>
                            <option value="columns3" <?php echo esc_attr( ( $value == 'columns3' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '3 columns dropdown', 'mox' ); ?>
                            </option>
                            <option value="columns4" <?php echo esc_attr( ( $value == 'columns4' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '4 columns dropdown', 'mox' ); ?></option>
                            <option value="columns5" <?php echo esc_attr( ( $value == 'columns5' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '5 columns dropdown', 'mox' ); ?></option>
                        </select>
                    </label>
                </p>
                <?php
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="autodrop_submenu" <?php echo esc_attr( ( $value == 'autodrop_submenu' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Auto drop', 'mox' ); ?></option>
                            <option value="drop_to_left" <?php echo esc_attr( ( $value == 'drop_to_left' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Drop To Left Side', 'mox' ); ?></option>
                            <option value="drop_to_right" <?php echo esc_attr( ( $value == 'drop_to_right' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Drop To Right Side', 'mox' ); ?></option>
                            <option value="drop_to_center" <?php echo esc_attr( ( $value == 'drop_to_center' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Drop To Center', 'mox' ); ?></option>
                            <option value="drop_full_width" <?php echo esc_attr( ( $value == 'drop_full_width' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Full width', 'mox' ); ?></option>
                        </select>
                    </label>
                </p>
            <?php
            ...
            if($depth){
                ...
                <p class="description description-wide description_width_100 el_widget_area">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="" <?php echo esc_attr( ( $value == '' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Select Widget Area', 'mox' ); ?></option>
                            <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                    <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                        <option value="no_group" <?php echo esc_attr(  ( $value == 'no_group' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'No', 'mox' ); ?></option>
                        <option value="group" <?php echo esc_attr( ( $value == 'group' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Yes', 'mox' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            if($depth){
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="0" <?php echo esc_attr( ( $value == '0' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'No', 'mox' ); ?></option>
                            <option value="1" <?php echo esc_attr( ( $value == '1' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Yes', 'mox' ); ?></option>
                        </select>
                    </label>
                </p>
            <?php }
            ...
            <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d1">
                <label for="edit-<?php echo esc_attr( ($key) . '-' . ($item_id) ); ?>">
                    <?php echo do_shortcode( $title ); ?><br />
                    <input type="text" value="<?php echo esc_attr( $value ); ?>" id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>" />
                    <input alt="#TB_inline?height=400&width=500&inlineId=<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) . '-popup' ); ?>" title="<?php _e( 'Click to browse icon', 'mox' ) ?>" class="thickbox button-secondary submit-add-to-menu" type="button" value="<?php _e( 'Browse Icon', 'mox' ) ?>" />
            ...
            if ( ! $depth ) {
                ...
                <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d2">
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <span class='obtheme_long_desc'><?php echo do_shortcode( $title ); ?></span><br />
                        <input type="text" value="<?php echo esc_attr( $value ); ?>" id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>" />
                        <button id="browse-edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class="set_custom_images button button-secondary submit-add-to-menu"><?php _e( 'Browse Image', 'mox' ); ?></button>
                        <a class="button btn_clear button-primary" href="javascript: void(0);"><?php _e( 'Clear', 'mox' ); ?></a>
                    </label>
                </p>
