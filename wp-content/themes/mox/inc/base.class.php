...
class ZO_Base
{
    ...
    public static function getPageTitle(){
        ...
        if (!is_archive()){
            ...
            /* search */
            elseif (is_search()):
                printf( __( 'Search Results for: %s', 'mox' ), '<span>' . get_search_query() . '</span>' );
            /* 404 */ 
            elseif (is_404()):
                _e( '404', 'creativ');
            /* other */
            ...
            /* author. */
            elseif ( is_author() ) :
                printf( __( 'Author: %s', 'mox' ), '<span class="vcard">' . get_the_author() . '</span>' );
            /* date */
            elseif ( is_day() ) :
                printf( __( 'Day: %s', 'mox' ), '<span>' . get_the_date() . '</span>' );
            elseif ( is_month() ) :
                printf( __( 'Month: %s', 'mox' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'mox' ) ) . '</span>' );
            elseif ( is_year() ) :
                printf( __( 'Year: %s', 'mox' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'mox' ) ) . '</span>' );
            /* post format */
