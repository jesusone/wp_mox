...
class ZoTheme_StaticCss
{
    ...
    public function css_render()
    {
		...
		zo_setvariablescss($smof_data['secondary_color'],'$secondary_color','#fff');
        ...
        /* Start header option*/
        if(!empty($smof_data['menu_reponsive_icon'])){
        ...
        if(!empty($smof_data['menu_reponsive_icon'])){
            echo  "body #zo-header.zo-header-style-1 #zo-menu-mobile i {
                  color:".esc_attr($smof_data['menu_reponsive_icon']).";
