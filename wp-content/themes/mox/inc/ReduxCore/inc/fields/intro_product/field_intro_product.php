            ...
            <div class="intro-product">
                ...
                <div class="zo-tools">
                    <ul>
                        ...
                        <li><a href="<?php echo esc_url('http://zotheme.com/forum');?>"><i class="dashicons dashicons-groups"></i><span><?php _e("Forum Support", 'creativ'); ?></span></a></li>
                        <li><a href="<?php echo esc_url('http://themeforest.net/user/ZoTheme/portfolio?WT.ac=portfolio_item&WT.z_author=ZoTheme');?>"><i class="dashicons dashicons-products"></i><span><?php _e("ZoTheme", 'creativ'); ?></span></a></li>
                        <li><a href="mailto:wp@zotheme.com"><i class="dashicons dashicons-email"></i><span><?php _e("Contact Now", 'creativ'); ?></span></a></li>
                    </ul>
                </div>
