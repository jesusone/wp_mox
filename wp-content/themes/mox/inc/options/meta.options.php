            ...
            <div class='panel-container'>
                <div id="tabs-general">
                    ...
                    zo_options(array(
                        ...
                        'follow' => array('1' => array('#page_full_width_enable'))
                    ));
                      ?>  <div id="page_full_width_enable">
                                <div id="page_content_width_seting_default">
                                    <?php
                                    zo_options(array(
                                            'id' => 'content_width_enable',
                                            'label' => __('Content width', 'creativ'),
                                            'type' => 'switch',
                                            'options' => array('on' => '1', 'off' => ''),
                                            'follow' => array('1' => array('#page_content_width_enable'))

                                    ));
                                    ?>
                                </div>
                                    <div id="page_content_width_enable">
                                        <?php
                                        zo_options(array(
                                            'id' => 'content_width',
                                            'label' => __('Show Content Width', 'creativ'),
                                            'type' => 'select',
                                            'options' => array(
                                                '1678px' => '1648 px',
                                                '1280px' => '1250 px',
