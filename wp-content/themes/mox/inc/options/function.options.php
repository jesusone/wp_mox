...
$this->sections[] = array(
    ...
    'fields' => array(
        array(
            ...
            'default' => 'creativ',
            'options' => array(
                'creativ' => get_template_directory_uri().'/assets/images/dummy/zap.png'
            ),
            'type' => 'image_select',
            'title' => 'Select Theme'
        )
...
$page_title = array(
    ...
    array(
        ...
        'type'     => 'background',
        'title'    => __( 'Background', 'mox' ),
        'subtitle' => __( 'page title background with image, color, etc.', 'mox' ),
...
foreach( $post_types as $type => $name) {
    $page_title[] = array(
        ...
        'subtitle' => sprintf( __( 'Custom background image for post type %s', 'mox' ), $name),
...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'     => 'background',
            'title'    => __( 'Background', 'mox' ),
            'subtitle' => __( 'body background with image, color, etc.', 'mox' ),
            'output'   => array('body'),
        ),
        array(
            'id' => 'body_margin',
...
$this->sections[] = array(
    ...
    'fields' => array(
        array(
            ...
            'type'     => 'background',
            'title'    => __( 'Background', 'mox' ),
            'subtitle' => __( 'Container background with image, color, etc.', 'mox' ),
            'output'   => array('#main'),
        ),
        array(
            'id' => 'container_margin',
...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'     => 'background',
            'title'    => __( 'Background', 'mox' ),
            'subtitle' => __( 'footer background with image, color, etc.', 'mox' ),
...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'     => 'background',
            'title'    => __( 'Background', 'mox' ),
            'subtitle' => __( 'background with image, color, etc.', 'mox' ),
