        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <?php if (is_active_sidebar('sidebar-6')) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 footer-second"><?php dynamic_sidebar('sidebar-6'); ?></div>
                <?php endif; ?>
                <?php if (is_active_sidebar('sidebar-7')) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 footer-third"><?php dynamic_sidebar('sidebar-7'); ?></div>
                <?php endif; ?>
                <?php if (is_active_sidebar('sidebar-8')) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 footer-four"><?php dynamic_sidebar('sidebar-8'); ?></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
