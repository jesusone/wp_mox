...
class ZO_Social_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __('Social', 'mox'), // Name
            array('description' => __('Social Widget', 'mox'),) // Args
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Social', 'mox' ) : $instance['title'], $instance, $this->id_base);
        }
        ...
        $icon_lastfm = isset($instance['icon_lastfm']) ? (!empty($instance['icon_lastfm']) ? $instance['icon_lastfm']: 'fa fa-lastfm') : 'fa fa-lastfm';
        $link_lastfm = isset($instance['link_lastfm']) ? $instance['link_lastfm'] : '';
        ...
        if (!empty($title))
          ...
          if ($link_google != '') {
            ...
            if ($link_lastfm != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-original-title="LastFm" href="'.esc_url($link_lastfm).'"><i class="'.$icon_lastfm.'"></i></a></li>';
            }
    ...
    function update( $new_instance, $old_instance ) {
         ...
         $instance['icon_lastfm'] = strip_tags($new_instance['icon_lastfm']);
         $instance['link_lastfm'] = strip_tags($new_instance['link_lastfm']);
    ...
    function form( $instance ) {
        ...
        $icon_lastfm = isset($instance['icon_lastfm']) ? esc_attr($instance['icon_lastfm']) : '';
         $link_lastfm = isset($instance['link_lastfm']) ? esc_attr($instance['link_lastfm']) : '';

         $extra_class = isset($instance['extra_class']) ? esc_attr($instance['extra_class']) : '';
         ?>
         <p><label for="<?php echo esc_url($this->get_field_id('title')); ?>"><?php _e( 'Title:', 'mox' ); ?></label>
         <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>

         <p><label for="<?php echo esc_url($this->get_field_id('style')); ?>"><?php _e( 'Style:', 'mox' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('style') ); ?>" name="<?php echo esc_attr( $this->get_field_name('style') ); ?>">
            <option value="default"<?php if( $style == 'default' ){ echo 'selected="selected"';} ?>><?php _e('Default', 'mox'); ?></option>
            <option value="style-1"<?php if( $style == 'style-1' ){ echo 'selected="selected"';} ?>><?php _e('Square', 'mox'); ?></option>
            <option value="style-2"<?php if( $style == 'style-2' ){ echo 'selected="selected"';} ?>><?php _e('Rounded Square', 'mox'); ?></option>
            <option value="style-3"<?php if( $style == 'style-3' ){ echo 'selected="selected"';} ?>><?php _e('Circle', 'mox'); ?></option>
            <option value="style-4"<?php if( $style == 'style-4' ){ echo 'selected="selected"';} ?>><?php _e('Box Style 1', 'mox'); ?></option>
            <option value="style-7"<?php if( $style == 'style-7' ){ echo 'selected="selected"';} ?>><?php _e('Box Style 2', 'mox'); ?></option>
            <option value="style-5"<?php if( $style == 'style-5' ){ echo 'selected="selected"';} ?>><?php _e('No List', 'mox'); ?></option>
            <option value="style-6"<?php if( $style == 'style-6' ){ echo 'selected="selected"';} ?>><?php _e('Circle Border', 'mox'); ?></option>
         </select>
         </p>

         <p><label for="<?php echo esc_url($this->get_field_id('align')); ?>"><?php _e( 'Content Align:', 'mox' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('align') ); ?>" name="<?php echo esc_attr( $this->get_field_name('align') ); ?>">
            <option value="text-left"<?php if( $align == 'text-left' ){ echo 'selected="selected"';} ?>><?php _e('Left', 'mox'); ?></option>
            <option value="text-center"<?php if( $align == 'text-center' ){ echo 'selected="selected"';} ?>><?php _e('Center', 'mox'); ?></option>
            <option value="text-right"<?php if( $align == 'text-right' ){ echo 'selected="selected"';} ?>><?php _e('Right', 'mox'); ?></option>
         </select>
         </p>

         <p><label for="<?php echo esc_url($this->get_field_id('icon_facebook')); ?>"><?php _e( 'Icon 1 Facebook:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_facebook')); ?>"><?php _e( 'Link 1:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_rss')); ?>"><?php _e( 'Icon 2 Rss:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_rss')); ?>"><?php _e( 'Link 2:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_youtube')); ?>"><?php _e( 'Icon 3 Youtube:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_youtube')); ?>"><?php _e( 'Link 3:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_twitter')); ?>"><?php _e( 'Icon 4 Twitter:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_twitter')); ?>"><?php _e( 'Link 4:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_google')); ?>"><?php _e( 'Icon 5 Google:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_google')); ?>"><?php _e( 'Link 5:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_skype')); ?>"><?php _e( 'Icon 6 Skype:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_skype')); ?>"><?php _e( 'Link 6:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_yahoo')); ?>"><?php _e( 'Icon 7 Yahoo:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_yahoo')); ?>"><?php _e( 'Link 7:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_dribbble')); ?>"><?php _e( 'Icon 8 Dribbble:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_dribbble')); ?>"><?php _e( 'Link 8:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_flickr')); ?>"><?php _e( 'Icon 9 Flickr:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_flickr')); ?>"><?php _e( 'Link 9:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_linkedin')); ?>"><?php _e( 'Icon 10 Linkedin:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_linkedin')); ?>"><?php _e( 'Link 10:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_vimeo')); ?>"><?php _e( 'Icon 11 Vimeo:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_vimeo')); ?>"><?php _e( 'Link 11:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_pinterest')); ?>"><?php _e( 'Icon 12 Pinterest:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_pinterest')); ?>"><?php _e( 'Link 12:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_github')); ?>"><?php _e( 'Icon 13 Github:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_github')); ?>"><?php _e( 'Link 13:', 'mox' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_instagram')); ?>"><?php _e( 'Icon 14 Instagram :', 'mox' ); ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('link_instagram')); ?>"><?php _e( 'Link 14:', 'mox' ); ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('icon_lastfm')); ?>"><?php _e( 'Icon 15 LastFm :', 'mox' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('icon_lastfm') ); ?>" name="<?php echo esc_attr( $this->get_field_name('icon_lastfm') ); ?>" type="text" value="<?php echo esc_attr( $icon_lastfm ); ?>" /></p>
        <p><label for="<?php echo esc_attr($this->get_field_id('link_instagram')); ?>"><?php _e( 'Link 15:', 'mox' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('link_lastfm') ); ?>" name="<?php echo esc_attr( $this->get_field_name('link_lastfm') ); ?>" type="text" value="<?php echo esc_attr( $link_lastfm ); ?>" /></p>
