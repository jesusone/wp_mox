...
function zo_setup() {
	 ...
	 */
	load_theme_textdomain( 'mox', get_template_directory() . '/languages' );
    ...
    register_nav_menu( 'primary', __( 'Primary Menu', 'mox' ) );
    register_nav_menu( 'primary-right', __( 'Menu head right', 'mox' ) );
    register_nav_menu( 'primary-left', __( 'Menu head left', 'mox' ) );
   /*
...
function zo_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Main Sidebar', 'mox' ),
		'id' => 'sidebar-1',
		'description' => __( 'Appears on posts and pages except the optional Front Page template, which has its own widgets', 'mox' ),
	...
	register_sidebar( array(
		'name' => __( 'Header Top Left', 'mox' ),
		'id' => 'sidebar-2',
		'description' => __( 'Appears when using the optional Header with a page set as Header top left', 'mox' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'Header Top Right', 'mox' ),
		'id' => 'sidebar-3',
		'description' => __( 'Appears when using the optional Header with a page set as Header top right', 'mox' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="wg-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Menu Right', 'mox' ),
    	'id' => 'sidebar-4',
    	'description' => __( 'Appears when using the optional Menu with a page set as Menu right', 'mox' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Content', 'mox' ),
    	'id' => 'sidebar-content',
    	'description' => __( 'Appears when using the optional Content with a page set as Content', 'mox' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 1', 'mox' ),
    	'id' => 'sidebar-5',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 1', 'mox' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 2', 'mox' ),
    	'id' => 'sidebar-6',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 2', 'mox' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 3', 'mox' ),
    	'id' => 'sidebar-7',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 3', 'mox' ),
	...
	register_sidebar( array(
    	'name' => __( 'Footer Top 4', 'mox' ),
    	'id' => 'sidebar-8',
    	'description' => __( 'Appears when using the optional Footer with a page set as Footer Top 4', 'mox' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Bottom Left', 'mox' ),
    	'id' => 'sidebar-9',
    	'description' => __( 'Appears when using the optional Footer Bottom with a page set as Footer Bottom left', 'mox' ),
    	'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
	...
	register_sidebar( array(
    	'name' => __( 'Footer Bottom Right', 'mox' ),
    	'id' => 'sidebar-10',
    	'description' => __( 'Appears when using the optional Footer Bottom with a page set as Footer Bottom right', 'mox' ),
    	'before_widget' => '<aside class="widget %2$s">',
    	'after_widget' => '</aside>',
    	'before_title' => '<h3 class="wg-title">',
    	'after_title' => '</h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Shop Menu Sidebar', 'mox' ),
        'id' => 'sidebar-11',
        'description' => __( 'Appears when using the optional Shop with Menu attach Widget', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Shop Sidebar', 'mox' ),
        'id' => 'sidebar-12',
        'description' => __( 'Appears when using the optional Shop with a page set as Shop page', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Header Right', 'mox' ),
        'id' => 'header-right',
        'description' => __( 'Appears when using the optional Cart & Search', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
	...
	register_sidebar( array(
        'name' => __( 'Header Top Sliders', 'mox' ),
        'id' => 'header-top-sliders',
        'description' => __( 'Appears when using the optional Revolution Sliders', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Footer Top Version Two', 'mox' ),
        'id' => 'footer-top-vesion-two',
        'description' => __( 'Appears when using the optional Footer with a page set as Footer top version two', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Footer Bottom Version Two', 'mox' ),
        'id' => 'footer-bottom-vesion-two',
        'description' => __( 'Appears when using the optional Footer with a page set as Footer bottom version two', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
    ...
    register_sidebar( array(
        'name' => __( 'Footer Version Photography', 'mox' ),
        'id' => 'footer-vesion-photography',
        'description' => __( 'Appears when using the optional Footer with a page set as Footer bottom version Photograpy', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
     ...
     register_sidebar( array(
        'name' => __( 'Footer Bottom Version One', 'mox' ),
    ...
    register_sidebar( array(
        'name' => __( 'Header Version Photography', 'mox' ),
        'id' => 'header-version-photography',
        'description' => __( 'Appears when using the optional Heade with a page set as Header version photography', 'mox' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="wg-title"><span>',
        'after_title' => '</span></h3>',
...
function zo_paging_nav($query = null) {
	...
	$links = paginate_links( array(
			...
			'prev_text' => __( '<i class="fa fa-angle-double-left"></i>', 'mox' ),
			'next_text' => __( '<i class="fa fa-angle-double-right"></i>', 'mox' ),
	) );
...
<div class="comment-main">
    <div class="comment-header">
        <?php printf( __( '<span class="comment-author">%s</span>', 'mox' ), get_comment_author_link() ); ?>
...
function zo_get_images_style($size= "full"){
    ...
    switch($size) {
		...
		case 'port_medium':
			...
			break;
        case '':
             return zo_post_thumbnail(360,331,true,true,true);
             break;
		case 'port_thumb':
