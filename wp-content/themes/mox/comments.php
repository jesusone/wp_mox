...
<div id="comments" class="comments-area">
    ...
    $args = array(
        ...
        'comment_field' => '<p class="comment-form-comment"><label for="email">' . __('Write your feedback here...', 'creativ') . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',
    );
    comment_form($args);
    ?>
